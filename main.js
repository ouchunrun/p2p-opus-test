...
async function onCreateOfferSuccess(desc) {
  ...
  try {
    desc.sdp = addOpusStereo(desc.sdp)
    console.warn('pc1 setLocalDescription sdp:\n' + desc.sdp)
  ...
  try {
    console.log('pc2 setRemoteDescription sdp:\n' + desc.sdp)
...
async function onCreateAnswerSuccess(desc) {
  ...
  try {
    console.log(`pc2 setLocalDescription sdp:\n${desc.sdp}`);
  ...
  try {
    console.warn(`pc1 setRemoteDescription sdp:\n${desc.sdp}`);
